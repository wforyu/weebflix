...
- **Android TV support (pertanyaan user 2026-08-03, Phase 1 DONE 2026-08-06):** APK Android biasa jalan di Android TV (sideload), tapi perlu penyesuaian:
  ...
  - **Phase 3 — TODO (belum dikerjakan):** (1) layout khusus TV (`layout-land`/`sw600dp`); (2) WebView player (Mega/abyssplayer/dll) navigasi D-pad di dalam WebView sulit → prefer ExoPlayer; (3) search on-screen keyboard di TV menyulitkan
