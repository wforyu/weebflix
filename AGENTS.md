...
- **YouTube player phase 2 (rencana user 2026-08-03):**
  1. **Orientasi player:** pertama kali buka video JANGAN langsung fullscreen — tampil layar kecil (portrait) dulu; pindah ke fullscreen (landscape) hanya saat user tap tombol fullscreen
  2. **Related/random di bawah player:** fragment RecyclerView di bawah video berisi konten random dari home provider YouTube, infinite scroll (dari bawah ke atas)
  3. **Hilangkan chip episode + chip server** di samping tombol gear khusus untuk player YouTube (hanya tombol gear resolusi yang tampil)
  4. **Sistem navigasi bawaan HP otomatis hilang** saat berada di dalam player YouTube (immersive nav bar)
  5. **Auto-play next video** ala YouTube — video rekomendasi/random dari YouTube diputar otomatis setelah video selesai
  6. **Navigasi Ongoing → Histori saat provider YouTube aktif:** tab Ongoing diganti "Histori"; info/landing fragment menjadi "Lanjutkan menonton" (bukan semua anime); isi konten mirip YouTube history = video yang ditonton tapi belum selesai; bisa lanjut dari durasi terakhir yang ditonton
